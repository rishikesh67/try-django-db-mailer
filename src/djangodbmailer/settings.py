"""
Django settings for djangodbmailer project.
...
SECRET_KEY = 'wt@a#z06aia_47xjfr@8$o$q)l%xbpxww%hapmd2&wi!dbw88r'
...
ROOT_URLCONF = 'djangodbmailer.urls'
...
WSGI_APPLICATION = 'djangodbmailer.wsgi.application'
